...
// Constants
const DEFAULT_EXTENSION_PATH = '../extension'
...
saveListOfUnusedTokensToFile(
	findUnusedTokens(
		getJSONKeys(`${DEFAULT_EXTENSION_PATH}/${DEFAULT_LOCALE_TOKENS_FILE}`),
		getFilepaths(
			[
				...
				{ dir: `${DEFAULT_EXTENSION_PATH}/app`, extensions: ['.jsx', '.js'] },
				{ dir: `${DEFAULT_EXTENSION_PATH}/src`, extensions: ['.js'] },
			]
		)
	)
);
